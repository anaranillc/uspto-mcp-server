...
| Phrase | `"booking availability"` | Exact phrase match |
...
- **Wrong:** `patentNumber:10467553`
- **Right:** `applicationMetaData.patentNumber:10467553`
...
```json
{
  "q": "applicationMetaData.inventionTitle:accommodations",
  "filters": [
    {
...
**Application-Level:**
- `applicationNumberText` — Application number (digits only, e.g., "13802025")
...
The ODP API expects **digits only** (e.g., `13802025`).
...
curl -s -H "x-api-key: YOUR_KEY" \
  "https://api.uspto.gov/api/v1/patent/applications/13802025" | head -c 200
```
...
### Patent Lookup (GET)
```bash
curl -X GET "https://api.uspto.gov/api/v1/patent/applications/13802025" \
  -H "x-api-key: YOUR_KEY" \
  -H "Accept: application/json"
```
