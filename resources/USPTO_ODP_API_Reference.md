...
GET /api/v1/patent/applications/search?q=applicationMetaData.patentNumber:10467553
...
**Example:**
```
GET /api/v1/patent/applications/13802025/
```
...
| Field search | `q=field:value` | `q=applicationMetaData.patentNumber:10467553` |
