...
def _expand_field_names(q: str) -> str:
    ...
    For example: "patentNumber:10467553" becomes "applicationMetaData.patentNumber:10467553"
...
async def patent_search(
    ...
    Query examples:
      ...
      - Combined: applicationMetaData.inventionTitle:accommodations AND applicationMetaData.filingDate:[2024-01-01 TO 2024-12-31]
...
async def patent_lookup(
    ...
    Provide ONE of:
      - application_number: e.g. "13802025" or "13/802,025" (slashes/commas stripped)
      - patent_number: e.g. "10467553" or "US10467553B2" (prefix/suffix stripped)
...
async def patent_application_detail(
    ...
    application_number: e.g. "13802025" (no slashes/commas).
